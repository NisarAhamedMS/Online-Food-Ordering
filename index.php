...
<head>
    ...
    <link rel="icon" href="#">
    <title>Black Chillies | Home </title>
    <!-- Bootstrap core CSS -->
        ...
        <section class="hero bg-image" data-image-src="images/img/res.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Taste The Best Of Indian Cuisines</h1>
                    <br><br><br>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We have got you covered with menus from over 20 delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We have got your covered with menus of more than 50 dishes online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your food delivered! And enjoy your meal! Pay online or Pay on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- start: FOOTER -->
  <br><center><p>Red Chillies &copy; 2018</p></center>
        <!-- end:Footer -->
</html>
