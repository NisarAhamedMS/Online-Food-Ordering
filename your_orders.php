...
<head>
    ...
    <link rel="icon" href="#">
    <title>Red Chillies | Your Orders</title>
    <!-- Bootstrap core CSS -->
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"]))
						...
						else
							{
									...
									// echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active"></a> </li>';
                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_res) > 0 )
														{
															echo '<td colspan="6"><center>You Have Not Placed Any Order Yet.</center></td>';
														}
													else
														{			      
...
<!-- start: FOOTER -->
<br><br><br><br><br><br><br><br><br><br><center><p>Red Chillies &copy; 2018</p></center>
        <!-- end:Footer -->
</html>
<?php
}
